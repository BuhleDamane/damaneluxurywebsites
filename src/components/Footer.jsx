...
const Footer = () => {
  return (
<footer className="bg-[#F7E7CE] height: 10vh; text-[#8B4513] pt-6 pb-4 px-6 mt-12 font-serif">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start space-y-10 md:space-y-0 md:space-x-12">
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start space-y-2 text-sm">
            <a href="/customer-care#delivery" className="hover:text-[#A0522D] transition">Delivery Info</a>
            <a href="/customer-care#returns" className="hover:text-[#A0522D] transition">Returns & Exchanges</a>
            <a href="/customer-care#faq" className="hover:text-[#A0522D] transition">FAQs</a>
            <a href="/customer-care#payment" className="hover:text-[#A0522D] transition">Payment Methods</a>
          </div>
        </div>
      ...
      <div className="text-center mt-05 text-sm tracking-wide space-x-2">
        <span>PayPal</span>
        <span>Visa</span>
      ...
      <div className="mt-4 text-center text-xs">
        &copy; {new Date().getFullYear()} Damane Luxury Furniture. All rights reserved.
      </div>
    </footer>
  );
};
